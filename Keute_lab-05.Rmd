...
*There are 6 pairings between all locations.
...
*There are 6 rows and 11 columns of combined data.  The names of the variables are:
...
*mutate() is the function from tidyverse that we use to add a new variable to a data frame while keeping the existing variables
...
```{r distance}
haversine(long1 = -150, lat1 = 61, long2 = -150, lat2=61, round=3) 
haversine(long1 = -150, lat1 = 61, long2 = -148, lat2=65, round=3) 
haversine(long1 = -150, lat1 = 61, long2 = -150, lat2=61, round=3) 
haversine(long1 = -150, lat1 = 61, long2 = -148, lat2=65, round=3) 
haversine(long1 = -148, lat1 = 65, long2 = -150, lat2=61, round=3) 
haversine(long1 = -148, lat1 = 65, long2 = -148, lat2=65, round=3)
```
The distances were calculated as follows for each pair:
...
***A dotplot would be the most appropriate visualization.
...
***Among the states I examined, Mitch Hedberg's joke is most likely to hold true in Texas.
